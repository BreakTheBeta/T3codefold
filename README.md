...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| **Live Codex voice**           | Have a live conversation while the host's coding agent works, with shared call controls and reconnect handling. [Voice setup](docs/user/providers-codex.md#talk-to-codex-fold-beta).                                | Web · Desktop · Mobile                   |
