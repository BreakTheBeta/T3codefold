...
/**
 * Backdrop artwork for the thread canvas: neon splatter on the themes listed
 * in BACKDROPS. The same SVGs the web app uses, generated by
 * scripts/generate-splatter-backdrops.ts.
 *
...
const BACKDROPS = {
  ...
  codex: {
    dark: {
      a: require("../../../assets/themes/codex-splatter-dark-a.svg"),
      b: require("../../../assets/themes/codex-splatter-dark-b.svg"),
    },
    light: {
      a: require("../../../assets/themes/codex-splatter-light-a.svg"),
      b: require("../../../assets/themes/codex-splatter-light-b.svg"),
    },
  },
} as const;
