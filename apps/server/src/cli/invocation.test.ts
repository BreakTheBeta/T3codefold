...
it("formats package runner commands from their cache entry paths", () => {
  for (const [entryPath, expected] of [
    [
      ...
      "npx --yes --prefer-online --package=https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.31/t3-0.0.31.tgz t3 serve",
    ],
    [
    ...
    [
      ...
      "pnpm --package=https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.31/t3-0.0.31.tgz dlx t3 serve",
    ],
    [
    ...
    [
      ...
      "bunx --package https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.31/t3-0.0.31.tgz t3 serve",
    ],
    [
...
it("re-suggests the nightly channel only for nightly builds", () => {
  for (const [version, expected] of [
    [
      ...
      "npx --yes --prefer-online --package=https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-nightly/t3.tgz t3 serve",
    ],
    [
      "0.0.31",
      "npx --yes --prefer-online --package=https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.31/t3-0.0.31.tgz t3 serve",
