    ...
    >
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command={`${foldServerCommand("latest")} connect`} className="mt-3" />
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <CommandBlock command={`${foldServerCommand("latest")} pair`} className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start T3 Code first, or run{" "}
              <code className="font-mono">{`${foldServerCommand("latest")} serve`}</code>. Add{" "}
