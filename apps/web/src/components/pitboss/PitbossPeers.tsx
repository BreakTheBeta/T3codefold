...
export function PitbossPeers({
  ...
  return (
    ...
    >
      <summary className="cursor-pointer text-sm font-semibold">Connected pitbosses</summary>
      <p className="my-2 text-xs text-muted-foreground">
        Each environment keeps its own pitboss. Sharing a tracker scope requires approval on both
