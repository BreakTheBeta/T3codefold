  ...
  it.effect("resolves the remote t3 package spec from the desktop release channel", () =>
    Effect.sync(() => {
      assert.equal(
        ...
        "https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.17/t3-0.0.17.tgz",
      );
      assert.equal(
        resolveRemoteT3CliPackageSpec({
        ...
        "https://github.com/BreakTheBeta/T3codefold/releases/download/fold-server-v0.0.17-nightly.20260415.44/t3-0.0.17-nightly.20260415.44.tgz",
      );
      assert.equal(
        resolveRemoteT3CliPackageSpec({
